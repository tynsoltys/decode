...
function App() {
    ...
    const block_a = new Block("a","#33BCAD", "#33BCAD","1");
    const block_b = new Block("b","#FEFF00", "#FEFF00","2");
    const block_c = new Block("c","#8781BD", "#8781BD","3");
    const block_d = new Block("d","#F58221", "#F58221","4");
    const block_e = new Block("e","#8ED8F7", "#8ED8F7","5");
    const block_f = new Block("f","#F6ADCD", "#F6ADCD","6");
    const block_g = new Block("h","#583F99", "#583F99","7");
    const block_h = new Block("g","#EB008C", "#EB008C","8");
    const block_i = new Block("i","#03AEEF", "#03AEEF","9");
    const block_j = new Block("j","#eeeeee", "#33BCAD","0");
    ...
    const block_space = new Block("space", "#C4C9CF", "#000000", "", "space");
        ...
        <header>
          ...
          <div className="block-zone">
            ...
            <div className="result-zone">
              ...
              <input type="text" id="result-field" className="result-field" value={result} onClick={() => console.log(resultField)}/>
